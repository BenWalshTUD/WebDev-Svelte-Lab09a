		...
		<div class="container-fluid main-wrapper">
			...
			<div class="collapse navbar-collapse" id="navbarNav">
				<ul class="navbar-nav me-auto">
					<li class="nav-item">
						<a class="nav-link active" href="/admin"><i class="bi bi-house me-1"></i>Home</a>
					</li>
					<li class="nav-item">
						<a class="nav-link" href="/admin/products"><i class="bi bi-shop me-1"></i>Products</a>
					</li>
                    <li class="nav-item">
                        <a class="nav-link" href="/admin/categories"><i class="bi bi-list-columns me-1"></i>Categories</a>
                    </li>
					<li class="nav-item">
